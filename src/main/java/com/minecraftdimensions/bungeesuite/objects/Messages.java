...
public class Messages {
    ...
    public static String TELEPORT_WAIT = colorize( m.getString( "TELEPORT_WAIT", "&c" + "You will get teleported in {wait_time} seconds" ) );
    ...
    public static void reloadMessages() {
        ...
        TELEPORT_WAIT = colorize( m.getString( "TELEPORT_WAIT", "&c" + "You will get teleported in {wait_time} seconds" ) );
        // warp specific messages
